...
public class GskelTabLayoutScrollPanel extends ScrollPanel
{
	...
	public class GskelTabLayoutScrollPanelResizeHandler implements ResizeHandler
	{
		...
		{
			reSize();
			gskelVerticalPanel.tabLayoutScrollPanelResizeInterfaceAction("resized");
		}
	}
	public interface GskelTabLayoutScrollPanelInterface 
	{
		void tabLayoutScrollPanelResizeInterfaceAction(String message);
